...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UrlAddress *url=(UrlAddress *)[_resultList objectAtIndex:row];
	cell.textLabel.text =url.groupname;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    _selectedText =((UrlAddress*) [_resultList objectAtIndex:[indexPath row]]).groupindex;//传小区的ID 
	[_delegate passValue:_selectedText andaddress:[_resultList objectAtIndex:[indexPath row]]];
}
